function selectSongListOfAccessCountLimit(tags, currentPage, a_id){
	...
	$.ajax({
		type:'GET',//提交数据方式
		url:serverURL + "/SelectSongLIstLimitOfAccessCount",
		async:false,
		...
		success:function(data){
			...
			if (a_id == "menu_a3") {
//				window.main.location.href = "MoreSongList.html";
			} else{
...
//					<li class="one_songList">
//						<div id="songList_img_div">
//							<img id="songList_img" alt="图片" src="#" />
//						</div>
//						<p id="songList_name">歌单名称</p>
//					</li>
//			
			var one_songList = $("<li>",{
				class:'one_songList',
